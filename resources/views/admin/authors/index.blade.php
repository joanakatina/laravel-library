        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                    @foreach($authors as $item) {{-- iš kontrolerio gavom autorių masyvą $authors; kadangi tai masyvas, reikia jį išskaidyti elementais --}}
                        <tr>
                            <td>{{ $item->id }}</td>
                            <td><a href="{{ url('admin/authors', $item->id) }}">{{ $item->first_name }}</a></td>
